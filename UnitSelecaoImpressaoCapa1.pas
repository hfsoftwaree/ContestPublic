unit UnitSelecaoImpressaoCapa1;
...
type
  TfrmSelecaoImpressao1 = class(TForm)
    Panel1: TPanel;
    GroupBox2: TGroupBox;
    GroupBox3: TGroupBox;
    BitBtn1: TBitBtn;
...
var
  frmSelecaoImpressao1: TfrmSelecaoImpressao1;
...
procedure TfrmSelecaoImpressao1.BitBtn3Click(Sender: TObject);
begin
Close;
end;

procedure TfrmSelecaoImpressao1.FormShow(Sender: TObject);
begin
...
procedure TfrmSelecaoImpressao1.FormClose(Sender: TObject;
...
procedure TfrmSelecaoImpressao1.BitBtn1Click(Sender: TObject);
begin
if Edit1.Text = '' then
begin
...
procedure TfrmSelecaoImpressao1.DBLookupComboBox11Click(Sender: TObject);
begin
Edit1.Text := DM.QFornecedor['CODIGOFORNECEDOR'];
end;


procedure TfrmSelecaoImpressao1.BitBtn4Click(Sender: TObject);
begin
Application.CreateForm(TfrmPesquisa, frmPesquisa);
frmPesquisa.Show;
end;

procedure TfrmSelecaoImpressao1.BitBtn2Click(Sender: TObject);
begin
if Edit1.Text = '' then
begin
Application.MessageBox('Fornecedor deve ser informado!', 'Informação', mb_Ok + mb_IconInformation);
